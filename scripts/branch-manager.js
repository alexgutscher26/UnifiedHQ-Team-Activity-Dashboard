...
class BranchManager {
   ...
   * It also identifies merged remote branches and attempts to delete them. Errors during deletion are logged without stopping the process.
   *
   ...
   * The status is determined based on the ahead and behind counts relative to the main branch.
   *
   ...
   * and performs the merge operation. If the mergeType is 'squash', it squashes the commits before merging.
   * Finally, it pushes the changes to the remote repository and logs the success or error message.
   *
  ...
  /**
   * Generate a pull request body template based on the source branch.
   */
