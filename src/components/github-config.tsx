...
interface GitHubConfigProps {
  onConfigUpdate?: (config: { owner: string; repo: string; token: string }) => void
}
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <p><strong>Note:</strong> This configuration is stored locally in your browser.</p>
          <p>For production use, set these as environment variables:</p>
          <ul className="list-disc list-inside ml-2 space-y-1">
            <li><code>NEXT_PUBLIC_GITHUB_OWNER</code></li>
            <li><code>NEXT_PUBLIC_GITHUB_REPO</code></li>
