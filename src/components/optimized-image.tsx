...
/**
 * Renders an optimized image component with various loading and error handling states.
 *
 * The component checks for WebP support, preloads critical images if marked as priority, and handles loading and error states through dedicated functions. It generates optimized image properties based on the provided dimensions and quality settings, and displays a loading placeholder or error message as needed.
 *
 ...
 * @param priority - Indicates if the image should be preloaded (default is false).
 * @param className - Additional CSS classes for the image component (default is an empty string).
 ...
 * @param style - Additional inline styles for the image component.
 * @param onLoad - Callback function triggered when the image loads successfully.
 * @param onError - Callback function triggered when the image fails to load.
