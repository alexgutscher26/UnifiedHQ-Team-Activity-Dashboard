...
export function GitHubConnection({ onConnectionUpdate }: GitHubConnectionProps) {
          ...
          <div className="space-y-4">
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertDescription className="text-green-800">
                GitHub account connected successfully! You can now see real activity data.
              </AlertDescription>
            </Alert>
          ...
          <div className="space-y-4">
            <Alert className="border-orange-200 bg-orange-50">
              ...
              <AlertDescription className="text-orange-800">
                Connect your GitHub account to see real activity data from your repositories.
              </AlertDescription>
            </Alert>
